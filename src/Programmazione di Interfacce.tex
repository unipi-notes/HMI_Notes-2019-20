...
Dopo vari fasi di pretotyping e aver abbastanza sicurezze sul successo del prodotto, lo step successivo è produrre il Minimum Viable Product , cioè la \textbf{versione minimale del prodotto che contiene solo ed esclusivamente le features che rappresentano il business che si è pretotipato attraverso il percorso precedente}.
Non si ha ancora per le mani un prodotto definitivo besì un qualcosa di vendibile, in modo da ottenere del ricavo e dell'utile, che se sufficiente, permetterebbe la produzione definitiva del prodotto.
...
\begin{figure}[!h]
	...
	\includegraphics[scale=0.5]{immagini/Imp.png}
