...
Per \textbf{definire gli scenarios}, è necessario \textbf{mapparli}. Bisogna partire \textbf{avendo già le personas e le relative user stories}, e individuare per ogni persona un key task che essa deve svolgere. Si possono scrivere gli scenarios racchiudendo una o più
...
\begin{itemize}
	...
	\item Un \textbf{Facade} è una sorta di Impersonator ma usato per dare un'immagine dell'azienda e non del prodotto stesso. Viene usato spesso per promuovere servizi.
...
Il termine \textbf{Industria 4.0} indica l'ultima fase del processo con cui l'automazione industriale ad \textbf{integra} nuove \textbf{tecnologie produttive} per \textbf{migliorare} le condizioni di lavoro, creare nuovi modelli di business e aumentare la produttività e la qualità produttiva degli impianti.
...
Un \textbf{Conversational System} è un'interfaccia uomo macchina in grado di comprendere \textbf{il linguaggio umano} e condurre una conversazione scritta o verbale con l'utente. È usata per migliorare l'esperienza dell'utente guidandone l'interazione durante l'uso del prodotto.
...
Inoltre per aiutare il sistema a interagire con gli utenti e a riconoscere il comando si definiscono anche delle \textbf{utterances}, ovvero delle frasi di esempio con diversa struttura ma uguale significato. Un insieme di \textbf{utterances} fa riferimento ad un \textbf{intento}.
